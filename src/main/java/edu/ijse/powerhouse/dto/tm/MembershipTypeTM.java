...
public class MembershipTypeTM {
    ...
    public MembershipTypeTM() {
    }

    public MembershipTypeTM(String membership_type_id, String name, String description, String duration, Double price, String features, String status) {
