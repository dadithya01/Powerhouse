...
public class MealListTM {
    ...
    public MealListTM(String meal_id, String diet_plan_id, String name, String description, String meal_time, int calories, int protein, int carbs, int fat, String recipe) {
