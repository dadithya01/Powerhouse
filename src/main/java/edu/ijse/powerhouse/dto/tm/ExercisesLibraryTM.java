...
public class ExercisesLibraryTM {
    ...
    public ExercisesLibraryTM() {
    }

    public ExercisesLibraryTM(String exercise_id, String name, String description, String muscle_group, String equipment_needed, String difficulty_level, String video_url, String instructions, String added_by) {
