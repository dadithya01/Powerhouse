...
public class WorkoutPlanListDto {
    ...
    public WorkoutPlanListDto() {
    }

    public WorkoutPlanListDto(String workout_plan_id, String name, String description, String difficulty_level, String created_by, String created_date, String duration_weeks) {
